# -*- coding: utf-8 -*-
"""
Created on Sat Jan 11 01:39:41 2020
...
easily readable, and easily modifiable. It is not optimized, and omits
...
class Network(object):
    ...
    def feedforward(self, a):
        """Return the outpout of the network if "a" is input"""
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta, test_data=None):
        ...
        the inputs and the desired outputs. The other non-optional parameters are
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        "mini_batch" is a list of tuples "(x,y)", and "eta" is the learning
        rate. """
    ...
    def backprop(self, x, y):
        ...
        # feedfoward
        activation = x
        activations = [x] # List ot store all the activations, layer by layer
        ...
        # Note that the l in the loop below is used a little
        ...
        # used here to take advantage of the fact that Python ca use
    ...
    def evaluate(self, test_data):
        ...
        networks outputs the correct result. Not that the neural network's
